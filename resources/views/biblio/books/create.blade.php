    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100">
                <h3 class="text-lg font-semibold text-gray-800">Nouveau livre</h3>
                <p class="text-sm text-gray-500 mt-0.5">Remplissez les informations pour ajouter un livre au catalogue.</p>
            </div>

            <form method="POST" action="{{ route('biblio.books.store') }}" enctype="multipart/form-data" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-5">
                        ...
                        <div class="max-w-xs">
                            ...
                            <x-text-input id="total_copies" name="total_copies" type="number" min="1" max="99" class="mt-1 block w-full" :value="old('total_copies', 1)" required />
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="border-2 border-dashed border-gray-200 rounded-xl p-4 text-center" x-data="{ preview: null }">
                            <div x-show="!preview" class="py-6">
                                ...
                                <p class="mt-2 text-xs text-gray-400">JPG, PNG ou WebP • Max 2 Mo</p>
                            </div>
